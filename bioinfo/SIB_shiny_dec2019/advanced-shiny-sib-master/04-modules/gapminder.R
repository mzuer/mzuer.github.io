...
# Define UI --------------------------------------------------------------------
ui <- fluidPage(
  # additional elements before calling the modules
...
server <- function(input, output) {
  ...
  # the code is written once to define how to filter and plot the data
  # call the function gapModule and pass the parameters
  
  # with the callModule -> call the server
